...
SECRET_KEY = 'lua%&1w$w$y*eh)(jw@vk5phgrrsa_%g!ukbm&wjh$!$hu_#4_'
...
WSGI_APPLICATION = 'Tuljha.wsgi.application'
...
# Media files settings (for user-uploaded files)
